...
import ServerTCPP.Client.ImageHandler;
import ServerTCPP.Client.Shot;
import ServerTCPP.Client.GamePanel;
...
public class Player implements Serializable {
    ...
    double r;
    boolean up, down, left, right, mousepressed;
    public boolean shoot;
    private boolean space;
    int cd;   //cd = cooldown (fire rate på vapnet inte the 2x)
    private int x, y, xSpeed, ySpeed, ms, hp, jumpsLeft, jumpCooldown, points;
    ...
    public void drawPlayer(Graphics g) {
        ...
        try {
            ...
            g2d.drawImage(ImageHandler.getPlayerImages()[hp][imageInt][(int)animationFrame],0,0,width*dir,height,null);
        }
