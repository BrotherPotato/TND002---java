...
public class Exercise {
	...
	public static void main(String[] args) throws IOException {
		...
		String profession, name; int salary; Company theCompany = new Company();
		Employee dummy; ArrayList<Employee> availableWorkers; int response;
		
		System.out.println("Adding employees to the company.");
		do {
			System.out.print("Profession (Worker, Director, end) : "); profession = reader.readLine();
			if (profession.equals("Worker") || profession.equals("Director")) {
				System.out.print("Name : "); name = reader.readLine();
				System.out.print("Salary : "); salary = Integer.valueOf(reader.readLine());
		...
		while ((availableWorkers = theCompany.availableWorkers()).size()>0) {
			...
			if ((dummy = theCompany.getDirector(name))!=null) {
				...
				System.out.println("Selection : "); response = Integer.valueOf(reader.readLine()); 
